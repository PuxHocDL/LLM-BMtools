"""Self-correction debug loop.

Iterates through debug rounds: execute the generated code, classify any
error, build directed feedback, regenerate. Stops on success, when the
error type is out of scope, when the round budget is spent, or when two
consecutive rounds produce near-identical code.
"""
